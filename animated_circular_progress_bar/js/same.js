...
var secondGaugeReadout = document.querySelector('.container:nth-of-type(2) .percentage > .value');
...
var fourthGaugeReadout = document.querySelector('.container:nth-of-type(4) .percentage > .value');
